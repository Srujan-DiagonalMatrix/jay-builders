...
describe('approved content contract', () => {
  ...
  it('renders every CTA label from its source module without substitutions', () => {
    render(<App />);
    const ctas = [headerHeroContent.primaryCta.label, headerHeroContent.secondaryCta.label, customerSaysContent.cta.label, ourWorkContent.cta.label, servicesContent.guidance.cta.label, projectSpotlightContent.cta.label, projectFormContent.cta.label, urgentAssistanceContent.primaryCtaLabel, urgentAssistanceContent.secondaryCta.label];
