...
export const imageManifest:readonly ImageAsset[]=[
 ...
 {...asset('OutdatedProp-spotlight-main','OutDatedProp','main.png','Project Spotlight main image','Renovated open-plan kitchen with a central island, dining area and garden doors','182:131',{x:50,y:48}),sourceFilename:'main.png',width:728,height:524,inlineSrc:`data:image/png;base64,${spotlightMain.replace(/\s/g,'')}`},
 {...asset('OutdatedProp-spotlight-detail-01','OutDatedProp','detail-01.png','Project Spotlight kitchen view','Renovated kitchen cabinetry and worktops','169:233'),sourceFilename:'detail-01.png',width:169,height:233,inlineSrc:`data:image/png;base64,${spotlightDetail01.replace(/\s/g,'')}`},
